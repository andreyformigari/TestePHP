...
MySQL - 10.1.37-MariaDB : Database - test_php_andreyf
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`test_php_andreyf` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `test_php_andreyf`;
